# Original file name: idx263_c512_02_TS_ConvNeXt_Eff_384_1_k65_cleaned
...
# ?? 5. LightningModule
TRAINER_CONFIG = {
    'default_root_dir': './experiments/NeXt_TDNN_light_C384_B1_K65',
...
# PRETRAINED_CHECKPOINT = './exp_compet/idx245_c512_02_TS_ConvNeXt_Eff_256_3_k7_cleaned/lightning_logs/version_0/checkpoints/s-epoch=37-loss=2.72-full_minimum=1.23-min_eer_seg=2.10.ckpt'
# RESTORE_LOSS_FUNCTION = True
# ======================== Test & onnx ======================== #

# 😀😀 for test 
# TEST_CHECKPOINT = './experiments/NeXt_TDNN_light_C384_B1_K65/lightning_logs/version_0/checkpoints/s-epoch=184-loss=3.02-full_minimum=1.21-min_eer_seg=2.09.ckpt'
TEST_CHECKPOINT = './experiments/NeXt_TDNN_light_C384_B1_K65/NeXt_TDNN_light_C384_B1_K65.pt'
